...
From trans_1 if the next stop is acct_1, which means it is a complete transaction description.  Of course the next stop can be trans_1 
but that would be a new one.  if the next one is trans_2, there is more data for this transaction.

Both trans_1 and trans_2 can lead to __end__
"""
